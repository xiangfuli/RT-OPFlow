...
public:
   ...
   */
  virtual uint8_t callback_func(Message *request_message, Message* response_message) = 0;
  virtual void send_message(Message *request_message) = 0;
  virtual uint8_t com_connected() = 0;
};
